...
export const getStudioSettings = async ( options?: RequestInit): Promise<StudioSettings> => {
...
export const updateStudioSettings = async (updateStudioSettingsBody: UpdateStudioSettingsBody, options?: RequestInit): Promise<StudioSettings> => {
...
export const getUpdateStudioSettingsMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateStudioSettings>>, TError,{data: BodyType<UpdateStudioSettingsBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateStudioSettings>>, TError,{data: BodyType<UpdateStudioSettingsBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateStudioSettings>>, {data: BodyType<UpdateStudioSettingsBody>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateStudioSettingsMutationBody = BodyType<UpdateStudioSettingsBody>
...
export const useUpdateStudioSettings = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateStudioSettings>>, TError,{data: BodyType<UpdateStudioSettingsBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {data: BodyType<UpdateStudioSettingsBody>},
        TContext
      > => {
...
export const getRevenueReport = async ( options?: RequestInit): Promise<RevenueItem[]> => {

  return customFetch<RevenueItem[]>(getGetRevenueReportUrl(),
  {
    ...options,
    method: 'GET'
 ...
 */
export const getGetNewClientsReportUrl = () => {




  return `/api/reports/new-clients`
}

export const getNewClientsReport = async ( options?: RequestInit): Promise<NewClientsItem[]> => {

  return customFetch<NewClientsItem[]>(getGetNewClientsReportUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetNewClientsReportQueryKey = () => {
    return [
    `/api/reports/new-clients`
    ] as const;
    }


export const getGetNewClientsReportQueryOptions = <TData = Awaited<ReturnType<typeof getNewClientsReport>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNewClientsReport>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetNewClientsReportQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getNewClientsReport>>> = ({ signal }) => getNewClientsReport({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getNewClientsReport>>, TError, TData> & { queryKey: QueryKey }
}

export type GetNewClientsReportQueryResult = NonNullable<Awaited<ReturnType<typeof getNewClientsReport>>>
export type GetNewClientsReportQueryError = ErrorType<unknown>
...
export function useGetNewClientsReport<TData = Awaited<ReturnType<typeof getNewClientsReport>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNewClientsReport>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetNewClientsReportQueryOptions(options)
 ...
 */
export const getGetCancellationsReportUrl = () => {
...
export const getCancellationsReport = async ( options?: RequestInit): Promise<CancellationsItem[]> => {

  return customFetch<CancellationsItem[]>(getGetCancellationsReportUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetCancellationsReportQueryKey = () => {
    return [
...
export const getGetCancellationsReportQueryOptions = <TData = Awaited<ReturnType<typeof getCancellationsReport>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCancellationsReport>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetCancellationsReportQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getCancellationsReport>>> = ({ signal }) => getCancellationsReport({ signal, ...requestOptions });
...
export type GetCancellationsReportQueryError = ErrorType<unknown>
...
export function useGetCancellationsReport<TData = Awaited<ReturnType<typeof getCancellationsReport>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCancellationsReport>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetCancellationsReportQueryOptions(options)
 ...
 */
export const getGetOccupancyReportUrl = () => {
...
export const getOccupancyReport = async ( options?: RequestInit): Promise<OccupancyReportItem[]> => {

  return customFetch<OccupancyReportItem[]>(getGetOccupancyReportUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetOccupancyReportQueryOptions = <TData = Awaited<ReturnType<typeof getOccupancyReport>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getOccupancyReport>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetOccupancyReportQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getOccupancyReport>>> = ({ signal }) => getOccupancyReport({ signal, ...requestOptions });
...
export function useGetOccupancyReport<TData = Awaited<ReturnType<typeof getOccupancyReport>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getOccupancyReport>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetOccupancyReportQueryOptions(options)
 ...
 */
export const getGetMembershipsReportUrl = () => {




  return `/api/reports/memberships`
}

export const getMembershipsReport = async ( options?: RequestInit): Promise<MembershipsReportItem[]> => {

  return customFetch<MembershipsReportItem[]>(getGetMembershipsReportUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetMembershipsReportQueryKey = () => {
    return [
...
export const getGetMembershipsReportQueryOptions = <TData = Awaited<ReturnType<typeof getMembershipsReport>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMembershipsReport>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetMembershipsReportQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getMembershipsReport>>> = ({ signal }) => getMembershipsReport({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getMembershipsReport>>, TError, TData> & { queryKey: QueryKey }
}

export type GetMembershipsReportQueryResult = NonNullable<Awaited<ReturnType<typeof getMembershipsReport>>>
export type GetMembershipsReportQueryError = ErrorType<unknown>
...
export function useGetMembershipsReport<TData = Awaited<ReturnType<typeof getMembershipsReport>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMembershipsReport>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetMembershipsReportQueryOptions(options)
...
export const listClasses = async ( options?: RequestInit): Promise<PilatesClass[]> => {
...
export const createClass = async (createClassBody: CreateClassBody, options?: RequestInit): Promise<PilatesClass> => {
...
export const getClass = async (id: number, options?: RequestInit): Promise<PilatesClass> => {
...
export const updateClass = async (id: number,
    createClassBody: CreateClassBody, options?: RequestInit): Promise<PilatesClass> => {
...
export const getUpdateClassMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateClass>>, TError,{id: number;data: BodyType<CreateClassBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateClass>>, TError,{id: number;data: BodyType<CreateClassBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateClass>>, {id: number;data: BodyType<CreateClassBody>}> = (props) => {
          const {id,data} = props ?? {};
...
export const updateClient = async (id: number,
    createClientBody: CreateClientBody, options?: RequestInit): Promise<Client> => {
...
export const cancelReservation = async (id: number, options?: RequestInit): Promise<void> => {
...
export const markAttendance = async (id: number,
    markAttendanceBody: MarkAttendanceBody, options?: RequestInit): Promise<Reservation> => {
...
export const getMarkAttendanceMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof markAttendance>>, TError,{id: number;data: BodyType<MarkAttendanceBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof markAttendance>>, TError,{id: number;data: BodyType<MarkAttendanceBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof markAttendance>>, {id: number;data: BodyType<MarkAttendanceBody>}> = (props) => {
          const {id,data} = props ?? {};
...
export const createMembership = async (createMembershipBody: CreateMembershipBody, options?: RequestInit): Promise<MembershipPlan> => {
...
export const getCreateMembershipMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createMembership>>, TError,{data: BodyType<CreateMembershipBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createMembership>>, TError,{data: BodyType<CreateMembershipBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createMembership>>, {data: BodyType<CreateMembershipBody>}> = (props) => {
          const {data} = props ?? {};
...
export const listClientMemberships = async ( options?: RequestInit): Promise<ClientMembership[]> => {
...
export const getListClientMembershipsQueryOptions = <TData = Awaited<ReturnType<typeof listClientMemberships>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listClientMemberships>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListClientMembershipsQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listClientMemberships>>> = ({ signal }) => listClientMemberships({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listClientMemberships>>, TError, TData> & { queryKey: QueryKey }
}

export type ListClientMembershipsQueryResult = NonNullable<Awaited<ReturnType<typeof listClientMemberships>>>
...
export function useListClientMemberships<TData = Awaited<ReturnType<typeof listClientMemberships>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listClientMemberships>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const createClientMembership = async (createClientMembershipBody: CreateClientMembershipBody, options?: RequestInit): Promise<ClientMembership> => {
...
export const getCreateClientMembershipMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createClientMembership>>, TError,{data: BodyType<CreateClientMembershipBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createClientMembership>>, TError,{data: BodyType<CreateClientMembershipBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createClientMembership>>, {data: BodyType<CreateClientMembershipBody>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateClientMembershipMutationResult = NonNullable<Awaited<ReturnType<typeof createClientMembership>>>
    export type CreateClientMembershipMutationBody = BodyType<CreateClientMembershipBody>
    export type CreateClientMembershipMutationError = ErrorType<unknown>

    /**
 * @summary Assign a membership to a client
 */
export const useCreateClientMembership = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createClientMembership>>, TError,{data: BodyType<CreateClientMembershipBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const deleteClientMembership = async (id: number, options?: RequestInit): Promise<void> => {
...
export const getDeleteClientMembershipMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteClientMembership>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteClientMembership>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteClientMembership>>, {id: number}> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteClientMembershipMutationResult = NonNullable<Awaited<ReturnType<typeof deleteClientMembership>>>
 ...
 * @summary Cancel a client membership
 */
export const useDeleteClientMembership = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteClientMembership>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getTodayClasses = async ( options?: RequestInit): Promise<PilatesClass[]> => {
...
export const getGetTodayClassesQueryOptions = <TData = Awaited<ReturnType<typeof getTodayClasses>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTodayClasses>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTodayClassesQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTodayClasses>>> = ({ signal }) => getTodayClasses({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTodayClasses>>, TError, TData> & { queryKey: QueryKey }
}

export type GetTodayClassesQueryResult = NonNullable<Awaited<ReturnType<typeof getTodayClasses>>>
...
export function useGetTodayClasses<TData = Awaited<ReturnType<typeof getTodayClasses>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTodayClasses>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const getRecentClients = async ( options?: RequestInit): Promise<Client[]> => {
...
export const getGetRecentClientsQueryOptions = <TData = Awaited<ReturnType<typeof getRecentClients>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getRecentClients>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetRecentClientsQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getRecentClients>>> = ({ signal }) => getRecentClients({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getRecentClients>>, TError, TData> & { queryKey: QueryKey }
}

export type GetRecentClientsQueryResult = NonNullable<Awaited<ReturnType<typeof getRecentClients>>>
...
export function useGetRecentClients<TData = Awaited<ReturnType<typeof getRecentClients>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getRecentClients>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const getDashboardOccupancy = async ( options?: RequestInit): Promise<OccupancyItem[]> => {
...
export const getGetDashboardOccupancyQueryOptions = <TData = Awaited<ReturnType<typeof getDashboardOccupancy>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDashboardOccupancy>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetDashboardOccupancyQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getDashboardOccupancy>>> = ({ signal }) => getDashboardOccupancy({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getDashboardOccupancy>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetDashboardOccupancy<TData = Awaited<ReturnType<typeof getDashboardOccupancy>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDashboardOccupancy>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const getDashboardTopClients = async ( options?: RequestInit): Promise<TopClientItem[]> => {
...
export const getGetDashboardTopClientsQueryOptions = <TData = Awaited<ReturnType<typeof getDashboardTopClients>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDashboardTopClients>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetDashboardTopClientsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getDashboardTopClients>>> = ({ signal }) => getDashboardTopClients({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getDashboardTopClients>>, TError, TData> & { queryKey: QueryKey }
}

export type GetDashboardTopClientsQueryResult = NonNullable<Awaited<ReturnType<typeof getDashboardTopClients>>>
...
export function useGetDashboardTopClients<TData = Awaited<ReturnType<typeof getDashboardTopClients>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDashboardTopClients>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const getDashboardWeeklyAttendance = async ( options?: RequestInit): Promise<WeeklyAttendanceItem[]> => {

  return customFetch<WeeklyAttendanceItem[]>(getGetDashboardWeeklyAttendanceUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetDashboardWeeklyAttendanceQueryOptions = <TData = Awaited<ReturnType<typeof getDashboardWeeklyAttendance>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDashboardWeeklyAttendance>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetDashboardWeeklyAttendanceQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getDashboardWeeklyAttendance>>> = ({ signal }) => getDashboardWeeklyAttendance({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getDashboardWeeklyAttendance>>, TError, TData> & { queryKey: QueryKey }
}

export type GetDashboardWeeklyAttendanceQueryResult = NonNullable<Awaited<ReturnType<typeof getDashboardWeeklyAttendance>>>
...
export function useGetDashboardWeeklyAttendance<TData = Awaited<ReturnType<typeof getDashboardWeeklyAttendance>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDashboardWeeklyAttendance>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const getDashboardPopularClasses = async ( options?: RequestInit): Promise<PopularClassItem[]> => {
...
export const getGetDashboardPopularClassesQueryOptions = <TData = Awaited<ReturnType<typeof getDashboardPopularClasses>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDashboardPopularClasses>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetDashboardPopularClassesQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getDashboardPopularClasses>>> = ({ signal }) => getDashboardPopularClasses({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getDashboardPopularClasses>>, TError, TData> & { queryKey: QueryKey }
}

export type GetDashboardPopularClassesQueryResult = NonNullable<Awaited<ReturnType<typeof getDashboardPopularClasses>>>
...
export function useGetDashboardPopularClasses<TData = Awaited<ReturnType<typeof getDashboardPopularClasses>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDashboardPopularClasses>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const sendTestNotification = async (id: number, options?: RequestInit): Promise<NotificationResult> => {
...
export const getSendTestNotificationMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendTestNotification>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof sendTestNotification>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof sendTestNotification>>, {id: number}> = (props) => {
          const {id} = props ?? {};
...
export const createCheckoutSession = async (createCheckoutSessionBody: CreateCheckoutSessionBody, options?: RequestInit): Promise<CheckoutSessionResult> => {
...
export const handleStripeWebhook = async ( options?: RequestInit): Promise<HandleStripeWebhook200> => {
